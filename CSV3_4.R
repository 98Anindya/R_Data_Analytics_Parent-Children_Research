...
write.csv(filtered_data, file = "D:/Work/test R/filtered_data4.csv", row.names = FALSE)
...
#To create the CSV file of the relevant Data
write.csv(new_data, file = "D:/Work/test R/Emotional_Intelligence.csv", row.names = FALSE)
